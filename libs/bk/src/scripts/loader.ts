import { Preset, ToneBlockTypes } from '@src/types/helix';
import { getArg } from '@src/utils/process';
import { Config, generatePlugin, Slider, SLIDER_DEFAULTS } from '@src/utils/slider';
